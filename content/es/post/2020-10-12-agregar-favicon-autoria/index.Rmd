...
Vi la charla [Bloguear con R Markdown](https://masalmon.eu/talks/2020-10-09-bloguear/) de _Maëlle Salmon_ en [LatinR 2020](https://latin-r.com/) y me entusiasmé con varias cosas! Como por ejemplo aprendí a insertar emoticones `r emojifont::emoji("grin")` `r emojifont::emoji("rainbow")` y, un poco más serio, a configurar la web para que quienes usan gitbub pueden hacer comentarios en este post. Los comentarios se hacen a través de **utterances** (software libre), que realiza un _issue_ de git por cada comentario que dejen. Maëlle explica cómo configurarlo [aquí](https://masalmon.eu/2019/10/02/disqus/) y la [guía oficial](https://utteranc.es/#configuration) también es muy clara.
