...
summary: Una discusión sobre las Islas Malvinas en el mapa base de OpenStreetMap y protocolos de visualización con datos del Instituto Geográfico Nacional.
...
```{r lectura_datos_espaciales, cache=TRUE}
library(sf)
