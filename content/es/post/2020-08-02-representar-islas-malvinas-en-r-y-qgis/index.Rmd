...
(*) **Actualización con aporte para HTML**: el 13 de agosto de 2020 [José Mourglia](https://github.com/jmourglia) aportó archivos tipo para para páginas web (HTML Leaflet + Java + CSS). El aporte puede consultarse en el [repositorio](https://github.com/nmorandeira/IGN_Malvinas) asociado.
