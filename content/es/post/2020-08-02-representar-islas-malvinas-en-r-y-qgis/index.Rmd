...
categories:
  ...
  - QGIS
image:
  caption: '[Islas Malvinas en la representación de IGN](/img/featured_Malvinas.jpg)'
  focal_point: ''
output:
  blogdown::html_page:
    toc: false
...
El código genera un mapa interactivo que tarda mucho en desplegarse en este sitio web, porque es muy pesada la capa de áreas protegidas (pero pueden correrlo en sus computadoras, allí no demora). Por ese motivo dejo a continuación una captura de pantalla. Los siguientes mapas son más rápidos, así que podrán interactuar en los próximos ejemplos.

![](/img/tmap_ESRI.png)

En la parte de abajo a la derecha del mapa dice que se está utilizando el entorno Leaflet e indica qué proveedor de mapas base se está usando. Si bien el proveedor por defecto parece cambiar según la versión y/o el día, con el selector de capas (arriba a la derecha, ver captura de pantalla), se puede elegir entre tres proveedores. Uno de estos proveedores, OSM, es libre pero tiene el nombre "Falkland Islands"; los restantes dos proveedores son de ESRI y tienen sólo algunas etiquetas y a algunas escalas. Ojo: no podemos usar los mapas base de ESRI este mapa base en cualquier circunstancia porque no es libre, ver los términos de uso de la licencia.
