...
<iframe seamless src="/static/es/leaflet_Malvinas/mapa_base1.html" width="100%" height="500"></iframe>
...
<iframe seamless src="/static/leaflet_Malvinas/mapa_base1.html" width="100%" height="500"></iframe>
...
![Conexión XYZ en QGIS](data/QGIS_1.png){width=100%}
...
![Representación con OSM en QGIS](data/QGIS_2.png){width=100%}
...
![Representación con Argenmap v2 de IGN en QGIS](data/QGIS_4.png){width=100%}
...
![Vista general del proyecto de QGIS](data/QGIS_5.png){width=100%}
