...
categories:
  ...
  - R
image:
  caption: '[Foto por Jaqueline Brandwayn en Unsplash](https://unsplash.com/photos/S8MSj5VzHxQ)'
  focal_point: center
output:
  blogdown::html_page:
    toc: false
...
## En RStudio: nuevo proyecto, la instalación de `blogdown` y _Hugo_. La configuración bilingüe.
...
<img src="img/post_webHugo/newpost.png" width="90%" alt="Ventana emergente para completar la información del post"/>
...
[¿Porqué necesitás tener una página web?](https://pamepairo.netlify.app/post/7-12-2020-motivos-pagina-web/)
[Creando una página web bilingüe en R](https://pamepairo.netlify.app/post/18-12-2020-creando-pagina-web/)

Pamela presentó una charla breve, que recomiendo, en la conferencia RStudio::global(2020) (en inglés, con subtítulos): _"An easy and friendly way to build your multilingual website"_. Dejo el video por si tienen interés.
<p> </p>
<p style="position: relative; padding: 30px 0px 57% 0px; height: 0; overflow: hidden;"><iframe src="https://www.youtube.com/watch?v=dbJV3niLym8" width="100%" height="100%" frameborder="0" style="display: block; margin: 0px auto; position: absolute; top: 0; left: 0;"></iframe></p>
<p> </p>