...
categories:
  ...
  - QGIS
image:
  caption: '[Islas Malvinas en la representación de IGN](/img/img_Malvinas/featured.jpg)'
  focal_point: ''
output:
  blogdown::html_page:
    toc: false
...
El código genera un mapa interactivo que tarda mucho en desplegarse en este sitio web, porque es muy pesada la capa de áreas protegidas (los siguientes mapas son más rápidos). Por ese motivo dejo una captura de pantalla.
...
![](/img/img_Malvinas/QGIS_1.png){width=100%}
...
![](/img/img_Malvinas/QGIS_2.png){width=100%}
...
![](/img/img_Malvinas/QGIS_3.png){width=100%}
...
![](/img/img_Malvinas/QGIS_5.png){width=100%}
